...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "crossplane-olm-operator",
	})
	if err != nil {
	...
	if err = ctrl.NewWebhookManagedBy(mgr).
		...
		WithValidator(&crossplanev1alpha1.CrossplaneConfigValidator{
			Client: mgr.GetClient(),
		}).
		Complete(); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "CrossplaneConfig")
		os.Exit(1)
	}
